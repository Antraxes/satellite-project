...
function dsinit(options) {
	...
	const sls = -119459e-10 * ss3 * (sz1 + sz3 - 14 - 6 * emsq);
	const sghs = ss4 * zns * (sz31 + sz33 - 6);
	let shs = -119459e-10 * ss2 * (sz21 + sz23);
	...
	let shll = -.00015835218 * s2 * (z21 + z23);
...
async function createSingleThreadRuntime() {
	const { default: createWasmModuleSingleThread } = await import("./base-release-DiaEWsvb.js");
...
async function createMultiThreadRuntime(options) {
	const { default: createWasmModuleMultiThread } = await import("./pthreads-release-BDer3C54.js");
