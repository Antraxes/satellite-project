...
Need to figure out if threejs has the ability to map like Processing does. It doesn't seem to but there is a formula that does the same thing so I can probably just implement it in a function. https://henry.codes/writing/how-to-map-a-number-between-two-ranges/

I do actually like this pivot to changing the colour of satellites based on age, it gives the project more of a sense of purpose in my opinion. Now its clearly displaying the fact that the majority of satellites are young.

<img src="./readme-images/satellites-with-colours.png" alt="all satellites plotted around the earth with colour" width="400"/>
